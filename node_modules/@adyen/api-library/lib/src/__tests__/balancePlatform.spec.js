...
const balancePlatform_1 = __importDefault(require("../services/balancePlatform"));
const models = __importStar(require("../typings/balancePlatform/models"));
let client;
let balancePlatform;
let scope;
beforeEach(() => {
    ...
    scope = (0, nock_1.default)(`${client.config.balancePlatformEndpoint}/${client_1.default.BALANCE_PLATFORM_API_VERSION}`);
    balancePlatform = new balancePlatform_1.default(client);
});
afterEach(() => {
    nock_1.default.cleanAll();
});
describe("Balance Platform", () => {
    ...
    describe("AccountHolders", () => {
        it("should support POST /accountHolders", async () => {
            ...
            const response = await balancePlatform.AccountHolders.create(request);
            expect(response.id).toBe("AH3227C223222B5CMD2SXFKGT");
            expect(response.legalEntityId).toBe("LE322KT223222D5FJ7THR293F");
        });
        it("should support GET /accountHolders/{id}", async () => {
            ...
            const response = await balancePlatform.AccountHolders.retrieve("AH32272223222B5CM4MWJ892H");
            expect(response.id).toBe("AH32272223222B5CM4MWJ892H");
            expect(response.balancePlatform).toBe("YOUR_BALANCE_PLATFORM");
        });
        it("should support PATCH /accountHolders/{id}", async () => {
            ...
            const response = await balancePlatform.AccountHolders.update("AH32272223222B5CM4MWJ892H", request);
            expect(response.status).toBe("Suspended");
        });
        it("should support GET /accountHolders/{id}/balanceAccounts", async () => {
            ...
            const response = await balancePlatform.AccountHolders.listBalanceAccounts("AH32272223222B5CM4MWJ892H", {
                params: {
                    "limit": "5",
                    "offset": "10"
                }
    ...
    describe("BalanceAccounts", () => {
        it("should support POST /balanceAccounts", async () => {
            ...
            const response = await balancePlatform.BalanceAccounts.create(request);
            expect(response.id).toBe(balanceAccountId);
        });
        it("should support GET /balanceAccounts/{balanceAccountId}/sweeps", async () => {
            ...
            const response = await balancePlatform.BalanceAccounts.listSweeps(balanceAccountId, {
                params: {
                    "limit": "5",
                    "offset": "10"
                }
        ...
        it("should support POST /balanceAccounts/{balanceAccountId}/sweeps", async () => {
            ...
            const response = await balancePlatform.BalanceAccounts.createSweep(balanceAccountId, request);
            expect(response.id).toBe(sweepId);
            expect(response.triggerAmount.value).toBe(50000);
        });
        it("should support DELETE /balanceAccounts/{balanceAccountId}/sweeps/{sweepId}", async () => {
        ...
        it("should support GET /balanceAccounts/{balanceAccountId}/sweeps/{sweepId}", async () => {
            ...
            const response = await balancePlatform.BalanceAccounts.retrieveSweep(balanceAccountId, sweepId);
            expect(response.id).toBe(sweepId);
            expect(response.status).toBe("active");
        });
        it("should support PATCH /balanceAccounts/{balanceAccountId}/sweeps/{sweepId}", async () => {
            ...
            const response = await balancePlatform.BalanceAccounts.updateSweep(balanceAccountId, sweepId, request);
            expect(response.status).toBe("inactive");
        });
        it("should support GET /balanceAccounts/{id}", async () => {
            ...
            const response = await balancePlatform.BalanceAccounts.retrieve(balanceAccountId);
            expect(response.id).toBe(balanceAccountId);
            expect(response.status).toBe("Active");
        });
        it("should support PATCH /balanceAccounts/{id}", async () => {
            ...
            const response = await balancePlatform.BalanceAccounts.update(balanceAccountId, request);
            expect(response.status).toBe("active");
            expect(response.timeZone).toBe("Europe/Amsterdam");
        });
        it("should support GET /balanceAccounts/{id}/paymentInstruments", async () => {
            ...
            const response = await balancePlatform.BalanceAccounts.listPaymentInstruments(balanceAccountId, {
                params: {
                    limit: "3",
                    offset: "6",
                }
    ...
    describe("General", () => {
        it("should support GET /balancePlatforms/{id}", async () => {
            scope.get(`/balancePlatforms/${balanceAccountId}`)
                .reply(200, {
                "id": balanceAccountId,
                "status": "Active"
            });
            const response = await balancePlatform.General.retrieve(balanceAccountId);
            expect(response.id).toBe(balanceAccountId);
            expect(response.status).toBe("Active");
        });
        it("should support GET /balancePlatforms/{id}/accountHolders", async () => {
            ...
            const response = await balancePlatform.General.listAccountHolders(balanceAccountId);
            expect(response.accountHolders.length).toBe(2);
            expect(response.accountHolders[0].id).toBe("AH32272223222B59DDWSCCMP7");
        });
    });
    describe("PaymentInstruments", () => {
        it("should support POST /paymentInstruments", async () => {
            ...
            const response = await balancePlatform.PaymentInstruments.create(request);
            expect(response.id).toBe(paymentInstrumentId);
            expect(response.balanceAccountId).toBe(balanceAccountId);
        });
        it("should support GET /paymentInstruments/{id}", async () => {
            ...
            const response = await balancePlatform.PaymentInstruments.retrieve(paymentInstrumentId);
            expect(response.id).toBe(paymentInstrumentId);
            expect(response.status).toBe("active");
        });
        it("should support PATCH /paymentInstruments/{id}", async () => {
            ...
            const response = await balancePlatform.PaymentInstruments.update(paymentInstrumentId, request);
            expect(response.id).toBe(paymentInstrumentId);
            expect(response.balanceAccountId).toBe("BA32272223222B5CM82WL892M");
        });
        it("should support GET /paymentInstruments/{id}/transactionRules", async () => {
            ...
            const response = await balancePlatform.PaymentInstruments.listTransactionRules(paymentInstrumentId);
            expect(response.transactionRules.length).toBe(2);
            expect(response.transactionRules[0].id).toBe("TR32272223222B5CMDGMC9F4F");
        });
    });
    describe("PaymentInstrumentGroups", () => {
        it("should support POST /paymentInstrumentGroups", async () => {
            ...
            const response = await balancePlatform.PaymentInstrumentGroups.create(request);
            expect(response.id).toBe(paymentInstrumentGroupId);
            expect(response.txVariant).toBe("mc");
        });
        it("should support GET /paymentInstrumentGroups/{id}", async () => {
            ...
            const response = await balancePlatform.PaymentInstrumentGroups.retrieve(paymentInstrumentGroupId);
            expect(response.id).toBe(paymentInstrumentGroupId);
            expect(response.txVariant).toBe("mc");
        });
        it("should support GET /paymentInstrumentGroups/{id}/transactionRules", async () => {
            ...
            const response = await balancePlatform.PaymentInstrumentGroups.listTransactionRules(paymentInstrumentGroupId);
            expect(response.transactionRules.length).toBe(2);
            expect(response.transactionRules[0].id).toBe("TR32272223222B5CMDGMC9F4F");
        });
    });
    describe("TransactionRules", () => {
        it("should support POST /transactionRules", async () => {
            ...
            const response = await balancePlatform.TransactionRules.create(request);
            expect(response.id).toBe(transactionRuleId);
            expect(response.status).toBe("active");
        });
        it("should support GET /transactionRules/{transactionRuleId}", async () => {
            ...
            const response = await balancePlatform.TransactionRules.retrieve(transactionRuleId);
            expect(response.transactionRule.id).toBe(transactionRuleId);
            expect(response.transactionRule.type).toBe("velocity");
        });
        it("should support PATCH /transactionRules/{transactionRuleId}", async () => {
            ...
            const response = await balancePlatform.TransactionRules.update(transactionRuleId, request);
            expect(response.status).toBe("inactive");
            expect(response.reference).toBe("myRule12345");
        });
        it("should support DELETE /transactionRules/{transactionRuleId}", async () => {
            ...
            const response = await balancePlatform.TransactionRules.delete(transactionRuleId);
            expect(response.id).toBe(transactionRuleId);
        });
    });
});
//# sourceMappingURL=balancePlatform.spec.js.map