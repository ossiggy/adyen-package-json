...
const models_1 = require("../typings/binlookup/models");
...
describe("Bin Lookup", function () {
    test("should succeed on get 3ds availability", async function () {
    ...
    test.each([false, true])("should succeed on get cost estimate. isMock: %p", async function (isMock) {
        ...
        const costEstimateRequest = {
            ...
            shopperInteraction: models_1.CostEstimateRequest.ShopperInteractionEnum.Ecommerce,
        };
