...
describe("Platforms Test", function () {
    ...
    describe("Fund", function () {
        const cases = [
            ...
            ["debitAccountHolder", (0, ts_auto_mock_1.createMock)(), (0, ts_auto_mock_1.createMock)()],
        ];
        test.each(cases)("should %p", async (...args) => {
    ...
    describe("Hop", function () {
        const cases = [
            ...
            ["getPciQuestionnaireUrl", (0, ts_auto_mock_1.createMock)(), (0, ts_auto_mock_1.createMock)()],
        ];
        test.each(cases)("should %p", async (...args) => {
