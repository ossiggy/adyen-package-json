...
const models_1 = require("../typings/payouts/models");
...
const mockStoreDetailRequest = (merchantAccount = process.env.ADYEN_MERCHANT) => ({
    ...
    entityType: models_1.StoreDetailRequest.EntityTypeEnum.Company,
    recurring: {
        contract: models_1.Recurring.ContractEnum.Payout,
    },
    merchantAccount,
});
