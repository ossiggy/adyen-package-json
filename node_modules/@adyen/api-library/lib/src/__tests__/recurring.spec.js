...
describe("Recurring", () => {
    test("should list recurring details", async () => {
        ...
        expect((_a = result.details) === null || _a === void 0 ? void 0 : _a[0].recurringDetailReference).toBe("recurringReference");
    });
    ...
    test("should send pre-debit Notification", async () => {
    ...
    test("should schedule account updater", async () => {
