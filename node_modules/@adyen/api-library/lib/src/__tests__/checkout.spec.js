...
describe("Checkout", () => {
    test("should add idempotency key to request headers", async () => {
    ...
    test("Should get card details", async () => {
        ...
        const cardDetailsReponse = await checkout.cardDetails(cardDetailsRequest);
        expect((_a = cardDetailsReponse === null || cardDetailsReponse === void 0 ? void 0 : cardDetailsReponse.brands) === null || _a === void 0 ? void 0 : _a.length).toBe(1);
    });
});
