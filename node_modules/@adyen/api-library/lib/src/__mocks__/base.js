...
const createClient = (apiKey = process.env.ADYEN_API_KEY) => {
    ...
    config.paymentEndpoint = client_1.default.PAYMENT_API_ENDPOINT_TEST;
    config.storedValueEndpoint = client_1.default.STOREDVALUE_API_ENDPOINT_TEST;
    config.terminalManagementEndpoint = client_1.default.TERMINAL_MANAGEMENT_API_ENDPOINT_TEST;
    config.managementEndpoint = client_1.default.MANAGEMENT_API_ENDPOINT_TEST;
    config.balancePlatformEndpoint = client_1.default.BALANCE_PLATFORM_API_ENDPOINT_TEST;
